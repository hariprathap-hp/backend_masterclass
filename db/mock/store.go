...
// Source: github.com/hariprathap-hp/backend_masterclass/db/sqlc (interfaces: Store)
...
import (
	...
	sqlc "github.com/hariprathap-hp/backend_masterclass/db/sqlc"
)
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 sqlc.TransferTxParams) (sqlc.TransferResult, error) {
	m.ctrl.T.Helper()
